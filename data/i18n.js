...
window.I18N = {
  ...
  ukrainian: {
    ...
    "chars.suzie.bio":  "Сюзанна, або просто Сюзі, — 12-річна молодша сестра Тари Уест. Поки Тара насолоджувалася життям із їжею та розкішними подарунками, Сюзі здавалося, що бітьки її зовсім ігнорують. В якийсь момент вона намагалася здатися, але коли це не вдалося, Сюзі почала чинити опір служінню Тарі і через це стала її найчастішою жертвою.",
    "chars.add.name":   "Додати персонажа",
    "chars.add.role":   "Шаблон",
    "chars.add.bio":    'Скопіюйте цей блок у <strong>characters.html</strong>, змініть шлях до зображення й додайте нові ключі для імені, ролі та опису у <strong>data/i18n.js</strong>. Сітка перебудується сама.',
